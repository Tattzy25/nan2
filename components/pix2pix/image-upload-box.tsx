...
export function ImageUploadBox({ imageNumber, preview, onDrop, onClear, onSelect }: ImageUploadBoxProps) {
  return (
    <div
      className={cn(
        "w-full h-[60px] sm:h-[80px] md:h-[100px] lg:h-[12vh] xl:h-[14vh] border-2 border-green-400 rounded-2xl md:rounded-3xl overflow-hidden flex items-center justify-center cursor-pointer hover:bg-green-400/10 transition-all bg-black/30 relative group",
